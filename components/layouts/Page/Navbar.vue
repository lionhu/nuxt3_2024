    ...
    >
      ...
      >
        ...
        <div class="pl-4 flex space-x-3 text-xl">
          ...
          <LayoutPageNavbarDropdownUserSwitcher />
          <AwesomeLink
      ...
      <AwesomeActionSheetGroup>
        ...
        <AwesomeActionSheetItem class="flex flex-col">
          <div class="pb-2">
            ...
            <div class="mt-2 mb-2 text-sm font-bold capitalize">User Menu</div>
            <LayoutPageNavbarDropdownUserSwitcher type="select-box" />
          </div>
        </AwesomeActionSheetItem>
      </AwesomeActionSheetGroup>
      <AwesomeActionSheetGroup>
