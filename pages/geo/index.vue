...
const { haversineDistance } = useGooglelocation()
...
const watcher: number | null = null
onMounted(() => {
  console.log('onMounted', lat.value, lng.value)
  ...
  // myMap.value = document.getElementById('googlemap') as HTMLElement
  // console.log(myMap)
})
...
const clickMap = (coords: any) => {
  const distance = haversineDistance(center.value, {
    lat: coords.latLng.lat(),
    lng: coords.latLng.lng(),
  })
  console.log('clickMap: ', distance)
  locations.value.push({ lat: coords.latLng.lat(), lng: coords.latLng.lng() })
}
</script>
